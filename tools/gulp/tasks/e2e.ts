...
import {buildConfig, sequenceTask, watchFiles, buildScssTask} from 'ngx-groundhog-build-tools';
...
task('e2e-app:build-scss', buildScssTask(outDir, appDir));
 ...
 */
task('serve:e2eapp:watch', ['serve:e2eapp', 'ngx-groundhog:watch', ':watch:e2eapp']);
